...
private:
	...
	CVector calcAimAngle(CVector localPos, CVector bonePos) { // высчитывание таких углов поворота персонажа, что направит его на кость
#ifdef DEBUG
		debug("calcAimAngle() \n");
#endif // DEBUG
	...
	CVector calcSmoothAngles(CVector cmd, CVector aimAngle) { // плавная наводка
#ifdef DEBUG
...
public:
	CVector calcSmoothAnglesFrame(CVector cmd, CVector aimAngle, float timedelta) { // плавная наводка
#ifdef DEBUG
		debug("calcSmoothAngles() \n");
#endif // DEBUG
